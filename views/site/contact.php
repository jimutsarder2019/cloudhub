		...
		<div class="row justify-content-center">
			<div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
				<div class="contact-us-promo p-5 bg-white rounded-custom custom-shadow text-center d-flex flex-column h-100">
					<span class="fa-3x text-primary fas fa-location-pin"></span>
					<div class="contact-promo-info mb-4">
						<h5>Address</h5>
						<p>944 Upper Jashore Road (1st Floor), Joragate Mor, Khulna-9000, Bangladesh.</p>
					</div>
					<a href="#" class="btn btn-link mt-auto">Google Map</a>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
				<div class="contact-us-promo p-5 bg-white rounded-custom custom-shadow text-center d-flex flex-column h-100">
					...
					<div class="contact-promo-info mb-4">
						<h5>Email Us</h5>
						<p>Simple drop us an email at <strong>info@cloudhub.com.bd</strong>
			...
			<div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
				<div class="contact-us-promo p-5 bg-white rounded-custom custom-shadow text-center d-flex flex-column h-100">
					...
					<div class="contact-promo-info mb-4">
						...
						<p>Give us a ring.Our Experts are standing by <strong>Sundy to Thursday</strong> from
							<strong>10am to 6pm (GMT+6)</strong>
						</p>
					</div>
					<a href="tel:+8801617622600" class="btn btn-link mt-auto">+8801617622600, +8809610203060</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row justify-content-lg-between align-items-center">
			...
			<div class="col-lg-5 col-md-10">
				<div class="contact-us-img">
					<img src="assets/img/contact-us-img-2.PNG" alt="contact us" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
