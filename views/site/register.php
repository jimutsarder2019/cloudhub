                    ...
                    <div class="col-lg-10 col-12">
                        <div class="pricing-content-wrap bg-custom-light rounded-custom shadow-lg">
                            <div class="price-feature-col pricing-feature-info text-white left-radius p-5 order-1 order-lg-0">
                                <a href="index.html" class="mb-5 d-none d-xl-block d-lg-block"><img src="<?=$baseUrl?>/cloudhub/img/cloudhub-white-logo.svg" width="100px" alt="logo" class="img-fluid logo-white" style="display: inline !important;"></a>
                                    ...
                                    <ul class="nav testimonial-tab-list mt-5" id="nav-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="active" href="#testimonial-tab-1" data-bs-toggle="tab" data-bs-target="#testimonial-tab-1" role="tab" aria-selected="true">
                                                <img src="<?=$baseUrl?>/cloudhub/img/testimonial/1.jpg" class="img-fluid rounded-circle" width="60" alt="user">
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#testimonial-tab-2" data-bs-toggle="tab" data-bs-target="#testimonial-tab-2" role="tab" aria-selected="false">
                                                <img src="<?=$baseUrl?>/cloudhub/img/testimonial/2.jpg" class="img-fluid rounded-circle" width="60" alt="user">
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#testimonial-tab-3" data-bs-toggle="tab" data-bs-target="#testimonial-tab-3" role="tab" aria-selected="false">
                                                <img src="<?=$baseUrl?>/cloudhub/img/testimonial/3.jpg" class="img-fluid rounded-circle" width="60" alt="user">
                                            </a>
                                        </li>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <ul class="list-unstyled list-inline mb-0">
                                            <li class="list-inline-item">
                                                <img src="<?=$baseUrl?>/cloudhub/img/clients/client-logo-1.svg" width="120" alt="clients logo" class="img-fluid py-3 me-3 customer-logo">
                                            </li>
                                            <li class="list-inline-item">
                                                <img src="<?=$baseUrl?>/cloudhub/img/clients/client-logo-2.svg" width="120" alt="clients logo" class="img-fluid py-3 me-3 customer-logo">
                                            </li>
                                            <li class="list-inline-item">
                                                <img src="<?=$baseUrl?>/cloudhub/img/clients/client-logo-3.svg" width="120" alt="clients logo" class="img-fluid py-3 me-3 customer-logo">
                                            </li>
                                            <li class="list-inline-item">
                                                <img src="<?=$baseUrl?>/cloudhub/img/clients/client-logo-4.svg" width="120" alt="clients logo" class="img-fluid py-3 me-3 customer-logo">
                                            </li>
                                            <li class="list-inline-item">
                                                <img src="<?=$baseUrl?>/cloudhub/img/clients/client-logo-5.svg" width="120" alt="clients logo" class="img-fluid py-3 me-3 customer-logo">
                                            </li>
                                            <li class="list-inline-item">
                                                <img src="<?=$baseUrl?>/cloudhub/img/clients/client-logo-6.svg" width="120" alt="clients logo" class="img-fluid py-3 me-3 customer-logo">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
